...
// ReadClock executes the TPM2_ReadClock command. On succesful completion,
// it will return a TimeInfo struct that contains the current value of
// time, clock, reset and restart counts.
