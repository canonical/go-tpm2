...
The current support status for each command group is detailed below.
 ...
 Enhanced Authorization (EA) Commands | Partial | All commands are supported except for TPM2_PolicyLocality, TPM2_PolicyCounterTimer, TPM2_PolicyPhysicalPresence, TPM2_PolicyNvWritten, TPM2_PolicyTemplate and TPM2_PolicyAuthorizeNV
