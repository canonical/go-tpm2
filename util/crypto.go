...
func CryptSecretDecrypt(priv crypto.PrivateKey, hashAlg crypto.Hash, label []byte, secret tpm2.EncryptedSecret) ([]byte, error) {
	...
	case *ecdsa.PrivateKey:
		...
		return internal.KDFe(hashAlg, zeroExtendBytes(mulX, sz), label,
